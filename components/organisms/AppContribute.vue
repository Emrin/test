    ...
    <div class="pt-3 mt-6 border-t border-light-border dark:border-dark-border">
      <h3
        ...
        class="
          ...
          ease-linear
          empty-after
          after:block after:border-2 after:rounded
          dark:after:border-dark-onSurfacePrimary
          light:after:border-light-onSurfacePrimary
          after:mt-2 after:mb-1 after:w-4/5
